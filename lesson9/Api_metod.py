...
class Api:
    ...
    @allure.step("Api. Получить токен автооизации")
...
# получение конкретной компании
    @allure.step("Api. Получение компании по {new_id}")
...
# изменение компании
    @allure.step("Api. Изменение компании{new_id}: {new_name}: {new_descr}")
...
# активация компании
    @allure.step("Api. Активация компании{id}: {isActive}")
...
# получить список сотрудников для компании
    @allure.step("Api. Получение списка сотрудников для компании{id}")
...
# добавление сотрудника 
    @allure.step("Api. Добавление нового сотрудника{new_id}:{firstName}:{lastName}:{phone}")
...
# изменить информацию о сотруднике 
    @allure.step("Api. Изменение информации сотрудника{id}:{new_name}:{new_mail}:{new_phone}:{isActive}")
